...
public class RSItems {
    ...
    public static final DeferredHolder<Item, ConchItem> ITEM_CONCH = ITEMS.register("conch_item_1", () -> new ConchItem(new Item.Properties().stacksTo(64)));
    ...
    public static final DeferredHolder<Item, NitroInkSacItem> NITRO_SAC = ITEMS.register("nitro_ink_sac", () -> new NitroInkSacItem(new Item.Properties().stacksTo(64)));
    public static final DeferredHolder<Item, TurboTubeItem> TURBO_TUBE = ITEMS.register("turbo_tube", () -> new TurboTubeItem(new Item.Properties().stacksTo(64).rarity(Rarity.UNCOMMON)));
