...
public class RSItems {
    ...
    public static final DeferredHolder<Item, ItemConch> ITEM_CONCH = ITEMS.register("conch_item_1", () -> new ItemConch(new Item.Properties().stacksTo(64)));
    ...
    public static final DeferredHolder<Item, ItemNitroInkSac> NITRO_SAC = ITEMS.register("nitro_ink_sac", () -> new ItemNitroInkSac(new Item.Properties().stacksTo(64)));
    public static final DeferredHolder<Item, ItemTurboTube> TURBO_TUBE = ITEMS.register("turbo_tube", () -> new ItemTurboTube(new Item.Properties().stacksTo(64).rarity(Rarity.UNCOMMON)));
