...
public class RSItems {
    ...
    public static final DeferredHolder<Item, ConchItem> ITEM_CONCH = ITEMS.register("conch_1", () -> new ConchItem(new Item.Properties().stacksTo(4)));
    @SuppressWarnings("unused")
    public static final DeferredHolder<Item, Conch2Item> ITEM_CONCH2 = ITEMS.register("conch_2", () -> new Conch2Item(new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    @SuppressWarnings("unused")
    public static final DeferredHolder<Item, Conch3Item> ITEM_CONCH3 = ITEMS.register("conch_3", () -> new Conch3Item(new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
