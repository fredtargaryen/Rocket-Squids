 ...
 */
public class AdultCapStorage implements ICapabilitySerializable<IAdultCapability> {
    private IAdultCapability instance;
    @Override
    ...
    @Override
    public @NotNull <T> LazyOptional<T> getCapability(@NotNull Capability<T> capability, @Nullable Direction dir) {
        return null;
    }

    @Override
    public IAdultCapability serializeNBT() {
        CompoundTag comp = new CompoundTag();
        comp.putDouble("pitch", instance.getRotPitch());
        comp.putDouble("yaw", instance.getRotYaw());
        comp.putDouble("targetPitch", instance.getTargetRotPitch());
    ...
    @Override
    public void deserializeNBT(IAdultCapability arg) {
        CompoundTag comp = (CompoundTag) nbt;
        instance.setRotPitch(comp.getDouble("pitch"));
        instance.setRotYaw(comp.getDouble("yaw"));
        instance.setTargetRotPitch(comp.getDouble("targetPitch"));
