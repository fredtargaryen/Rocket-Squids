...
public class Sounds {
    ...
    public static void constructAndRegisterSoundEvents(RegistryEvent.Register<SoundEvent> event) {
        SQUIDTP_IN = SoundEvent.createVariableRangeEvent(new ResourceLocation(MODID, "tpin"));
        SQUIDTP_OUT = SoundEvent.createVariableRangeEvent(new ResourceLocation(MODID, "tpout"));
